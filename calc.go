...
*/
var operator rune
var operatorCount int // Переменная для подсчета операторов
...
func main() {
	...
	// ограничение на ввод числа нуль согласно правке от ментора
	if num1 == 0 || num2 == 0 {
		panic("калькулятор не должен принимать число 0 ")
	}
